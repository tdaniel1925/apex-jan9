...
export default async function ReplicatedLandingPage({ params }: PageProps) {
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href={`/join/${agentCode}/opportunity`}>
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="pt-4 space-y-3">
                      <Button className="w-full" asChild>
                        <Link href={`/join/${agentCode}/signup`}>Join My Team</Link>
                      </Button>
                      <Button variant="outline" className="w-full" asChild>
                        <Link href={`/join/${agentCode}/contact`}>Contact Me</Link>
                      </Button>
                    </div>
                  </div>
                </CardContent>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" asChild>
              <Link href={`/join/${agentCode}/signup`}>Join Now</Link>
            </Button>
            <Button size="lg" variant="outline" asChild>
              <Link href={`/join/${agentCode}/contact`}>Ask Questions First</Link>
            </Button>
          </div>
        </div>
      </section>
