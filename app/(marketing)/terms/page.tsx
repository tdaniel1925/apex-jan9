/**
 * Terms of Service Page (Main Site)
...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Apex Affinity Group. Read our terms and conditions for using our website and services.',
};
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>Our total liability is limited to commissions actually paid to you in the preceding 12 months</li>
              <li>We are not responsible for actions of insurance carriers or third parties</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              ...
              the State of Texas, without regard to conflict of law principles. Any disputes
              shall be resolved through binding arbitration in Texas.
            </p>
          </CardContent>
        </Card>
