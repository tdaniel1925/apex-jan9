...
const SAMPLE_DATA: Record<string, string> = {
  ...
  dashboard_url: 'https://app.apexaffinity.com/dashboard',
  logo_url: 'https://app.apexaffinity.com/images/logo.png',
  ...
  reset_url: 'https://app.apexaffinity.com/reset-password?token=abc123',
