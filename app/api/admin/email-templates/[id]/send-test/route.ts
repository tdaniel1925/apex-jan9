...
const SAMPLE_DATA: Record<string, string> = {
  ...
  dashboard_url: process.env.NEXT_PUBLIC_APP_URL || 'https://app.theapexway.net',
  logo_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://app.theapexway.net'}/images/logo.png`,
  ...
  reset_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://app.theapexway.net'}/reset-password?token=test`,
  lead_name: 'Test Lead',
    ...
    if (resendApiKey) {
      try {
        const response = await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            from: process.env.RESEND_FROM_EMAIL || 'Apex Affinity Group <noreply@theapexway.net>',
            to: [recipient_email],
            subject,
            html: htmlContent,
            text: textContent,
